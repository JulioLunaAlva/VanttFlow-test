    ...
    return (
        <div className="space-y-8 pb-32 md:pb-8 pt-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="relative p-10 rounded-[2.5rem] glass-premium border-white/10 overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-8">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        <Button
                            variant="ghost"
                            className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl h-14 px-8 font-black tracking-widest uppercase text-xs transition-all hover:bg-white/10"
                            onClick={refresh}
                            disabled={loading}
                        >
                        ...
                        <Dialog>
                            ...
                            <DialogContent className="max-w-md rounded-[2.5rem] glass-premium border-white/10">
                                <DialogHeader>
                                ...
                                <div className="py-12 text-center space-y-6">
                                    <div className="w-28 h-28 bg-white/5 rounded-[2.5rem] flex items-center justify-center mx-auto mb-4 border-2 border-dashed border-white/10 rotate-3 transition-transform hover:rotate-6 duration-700">
                                        <Zap size={44} className="text-primary/40 -rotate-3" />
                                    </div>
                                    <div className="space-y-3">
                                        <h3 className="text-2xl font-black tracking-tighter text-white">Expansión Estratégica</h3>
                                    ...
                                    <div className="pt-4 px-4">
                                        <Button variant="outline" className="rounded-2xl w-full h-14 font-black tracking-widest uppercase text-[10px] border-white/10 bg-white/5" disabled>
                                            Lista de Espera VIP
                                        </Button>
                                    </div>
                                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {stats.map((stat, i) => (
                    <div key={i} className="glass-card card-glow border-white/10 overflow-hidden group hover:-translate-y-2 transition-all duration-700 cursor-default">
                        <div className="p-8 pb-4">
                            <div className="flex justify-between items-start mb-6">
                                <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg border border-white/10 transition-transform group-hover:scale-110 duration-500", stat.bg, stat.color)}>
                                    <stat.icon size={28} />
                                </div>
                                <div className={cn(
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="flex items-baseline gap-2">
                                    <span className="text-4xl font-black tracking-tight text-white group-hover:translate-x-1 transition-transform duration-500">{stat.prefix}{stat.value}</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-8 glass-card border-white/10 overflow-hidden">
                    <div className="p-6 border-b border-white/5 flex items-center justify-between">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-widest text-muted-foreground px-3 py-1 bg-white/5 rounded-full">Actualizado hace 2h</span>
                    </div>
                    <div className="p-10">
                ...
                <div className="lg:col-span-4 glass-premium card-glow border-primary/20 relative overflow-hidden group">
                    ...
                    <div className="p-10 flex flex-col h-full justify-between relative z-10">
                        <div>
                            ...
                            <h3 className="text-3xl font-black tracking-tighter text-white mb-6 leading-tight">Vantt Intelligence Engine</h3>
                        ...
                        <Dialog>
                            <DialogTrigger asChild>
                                <Button className="w-full h-14 rounded-2xl bg-primary text-white shadow-2xl shadow-primary/40 font-black tracking-widest uppercase text-[10px] transition-all hover:scale-105 active:scale-95">
                            ...
                            <DialogContent className="max-w-md rounded-[2.5rem] glass-premium border-white/10">
                                <DialogHeader>
                                    <DialogTitle className="text-2xl font-black tracking-tighter text-white">Market Intelligence</DialogTitle>
