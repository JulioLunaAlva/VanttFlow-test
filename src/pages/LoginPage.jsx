                ...
                <div className="mt-8 mb-4 flex flex-col items-center gap-4">
                    <Button 
                        ...
                        onClick={async () => {
                            ...
                            if (success) {
                                // Redirige después de que SyncContext haga su magia y recargue o estemos listos
                            }
                        }}
                        disabled={isSyncing}
                    >
                        ...
                        {isSyncing ? 'Sincronizando...' : 'Continuar con Google'}
                    </Button>

                    <Button variant="link" size="sm" onClick={() => navigate('/setup')} className="text-foreground/30 text-[10px] font-black uppercase tracking-[0.3em] hover:text-foreground/70 transition-colors mt-2">
                        {t('auth.forgot_pin')}
                    </Button>
                </div>
            </div>
